...
public class FilterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.compose).setOnClickListener(v -> {
            Intent intent = new Intent(FilterActivity.this, ComposeActivity.class);
            startActivity(intent);
        });

        findViewById(R.id.exoplayer).setOnClickListener(v -> {
            Intent intent = new Intent(FilterActivity.this, ExoPlayerActivity.class);
            startActivity(intent);
        });
