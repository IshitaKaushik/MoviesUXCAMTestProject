...
import org.notabug.lifeuser.moviedb.adapter.CastBaseAdapter;
...
public class DetailActivity extends BaseActivity {
        ...
        try {
            ...
            if (cursor.getCount() > 0) {
                ...
                if (!cursor.isNull(cursor.getColumnIndex
                    ...
                    watched = cursor.getInt(cursor.getColumnIndex(MovieDatabaseHelper
                            .COLUMN_PERSONAL_REWATCHED));
                } else if (cursor.getInt(cursor.getColumnIndex(
    ...
    public void editDetails(View view) {
        ...
        if (editShowDetails.getVisibility() == View.GONE) {
            ...
            editIcon.setImageResource(R.drawable.ic_check_black_24dp);
            ...
            categoriesView.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (getCategoryNumber(position) == 1
                        ...
                        Integer timesWatchedCount = cursor.getInt(cursor.getColumnIndex(
                                MovieDatabaseHelper.COLUMN_PERSONAL_REWATCHED));
            ...
            editIcon.setImageResource(R.drawable.ic_edit_black_24dp);
        }
    }
    ...
    private void updateEditShowDetails() {
        ...
        if (cursor.getCount() <= 0) {
            ...
            switch (cursor.getInt(cursor.getColumnIndex(
                    MovieDatabaseHelper.COLUMN_CATEGORIES))) {
                case MovieDatabaseHelper.CATEGORY_PLAN_TO_WATCH:
                    categories.setSelection(1);
                    break;
                case MovieDatabaseHelper.CATEGORY_WATCHED:
                    categories.setSelection(2);
                    break;
                case MovieDatabaseHelper.CATEGORY_ON_HOLD:
                    categories.setSelection(3);
                    break;
                case MovieDatabaseHelper.CATEGORY_DROPPED:
            ...
            if (!cursor.isNull(cursor.getColumnIndex
                    ...
                    && !cursor.getString(cursor.getColumnIndex(
                    MovieDatabaseHelper.COLUMN_PERSONAL_START_DATE)).equals("")) {
                String startDateString = cursor.getString(cursor.getColumnIndex(
                        MovieDatabaseHelper.COLUMN_PERSONAL_START_DATE));
                try {
                    startDate = parseDateString(startDateString, null, null);
                } catch (ParseException e) {
            ...
            if (!cursor.isNull(cursor.getColumnIndex
                    ...
                    && !cursor.getString(cursor.getColumnIndex(
                    MovieDatabaseHelper.COLUMN_PERSONAL_FINISH_DATE)).equals("")) {
                String finishDateString = cursor.getString(cursor.getColumnIndex(
                        MovieDatabaseHelper.COLUMN_PERSONAL_FINISH_DATE));
                try {
                    finishDate = parseDateString(finishDateString, null, null);
                } catch (ParseException e) {
            ...
            if (!cursor.isNull(cursor.getColumnIndex
                    ...
                    && !cursor.getString(cursor.getColumnIndex(
                    MovieDatabaseHelper.COLUMN_PERSONAL_REWATCHED)).equals("")) {
                timesWatched.setText(cursor.getString(cursor.getColumnIndex(
                        MovieDatabaseHelper.COLUMN_PERSONAL_REWATCHED
                )));
            } else {
            ...
            if (!cursor.isNull(cursor.getColumnIndex
                    ...
                    && !cursor.getString(cursor.getColumnIndex(
                    MovieDatabaseHelper.COLUMN_PERSONAL_EPISODES)).equals("")) {
                episodesSeen.setText(cursor.getString(cursor.getColumnIndex(
                        MovieDatabaseHelper.COLUMN_PERSONAL_EPISODES
                )));
            } else {
                if (cursor.getInt(cursor.getColumnIndex(
            ...
            if (!cursor.isNull(cursor.getColumnIndex(
                ...
                showRating.setText(cursor.getString(cursor.getColumnIndex(
                        MovieDatabaseHelper.COLUMN_PERSONAL_RATING
                )));
            }
        }
